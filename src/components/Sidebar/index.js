...
import { faCode, faHome, faUser, faEnvelope, faSuitcase, faFolderOpen, faBars, faClose } from '@fortawesome/free-solid-svg-icons'
    ...
    return(
        <div className = 'nav-bar'> 
            ...
            <nav className={showNav ? 'mobile-show' : ""}>
                ...
                <NavLink exact="true" activeclassname = "active" className = "research-link" to="/Research_papers">
                    <FontAwesomeIcon icon = {faCode} color = "#4d4d4e" onClick={() => setShowNav(false)} />
                </NavLink>
            ...
            <ul>
                ...
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://github.com/raya-jahan">

        ...
        <>
            <div className = "container about-page"> 
                <div className = "text-zone"> 
                    ...
                    <p>
                    I am an ambitious software engineer with a unique background that has prepared me to be a team player who communicates effectively, faces problems analytically and has the technical skills to tackle any challenge. 
                    <br/>
                    <DevList />
                    <Link to="/about" className="flat-button">LANGUAGES</Link>
                    <br/>
                    <Link to="/about/tech" className="flat-button">FRAMEWORKS/TECHNOLOGIES</Link>
                    <Link to="/about/certificates" className="flat-button">CERTIFICATIONS</Link>
                    </p>
                </div>
